...
To create factors in R, you make use of the function `r factor()`. First thing that you have to do is create a vector that contains all the observations that belong to a limited number of categories. For example, sex_vector contains the sex of 5 different individuals:
...
The function `r factor()` will encode the vector as a factor:
